...
- `nitkati_group` - Playwright adapter for the Nitkati Group site, with Cheerio-based detail-page parsing.
...
6. The adapter visits the query URL and returns listing drafts.
